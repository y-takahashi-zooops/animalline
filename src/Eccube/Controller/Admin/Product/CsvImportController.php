                ...
                function () use ($results, $headers) {
                    ...
                    foreach ($results as $row) {
                        $data = [
                            ...
                            $row->getProduct()->getProductImage() ? $row->getProduct()->getProductImage()[0]->getFileName() : '',
                            $row->getProduct()->getProductCategories() ? $row->getProduct()->getProductCategories()[0]->getCategoryId() : '',
                            $row->getStock() ?? '',
                            $row->getPrice01() ?? '',
                            $row->getPrice02() ?? '',
                            $row->getJanCode() ?? '',
