...
class ProductReviewController extends AbstractController
{
     ...
     */
    #[Route(
        '/%eccube_admin_route%/product_review/',
        name: 'product_review_admin_product_review'
    )]
    #[Route(
        '/%eccube_admin_route%/product_review/page/{page_no}',
        name: 'product_review_admin_product_review_page',
    ...
    : Response {
        ...
        return $this->render('@ProductReview42/admin/index.twig', [
            'searchForm' => $searchForm->createView(),
     ...
     */
    #[Route(
        '/%eccube_admin_route%/product_review/{id}/edit',
        name: 'product_review_admin_product_review_edit',
        requirements: ['id' => '\d+']
    )]
    public function edit(Request $request, ProductReview $ProductReview)
    {
        ...
        return $this->render('@ProductReview42/admin/edit.twig', [
     ...
     */
    #[Route(
        '/%eccube_admin_route%/product_review/{id}/delete',
        name: 'product_review_admin_product_review_delete',
        methods: ['DELETE'],
        requirements: ['id' => '\d+']
    )]
     ...
     */
    #[Route(
        '/%eccube_admin_route%/product_review/download',
        name: 'product_review_admin_product_review_download'
    )]
