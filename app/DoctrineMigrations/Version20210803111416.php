...
final class Version20210803111416 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE alm_breeder_pets');
        $this->addSql('DROP TABLE alm_breeders');
