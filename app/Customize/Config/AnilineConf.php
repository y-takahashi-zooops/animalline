...
final class AnilineConf
{
    ...
    const ANILINE_SHIPPING_STATUS_ACCEPT = 10; // 検体再送付手続済
    const ANILINE_SHIPPING_STATUS_INSTRUCTING = 10; // 検体再送付手続済
    const ANILINE_SHIPPING_STATUS_SHIPPED = 10; // 検体再送付手続済
}
