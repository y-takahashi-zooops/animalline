...
final class AnilineConf
{
    ...
    const ANILINE_DNA_CHECK_STATUS_DEFAULT = 1;
    const ANILINE_DNA_CHECK_STATUS_NOT_NORMAL = 6;
    const ANILINE_DNA_CHECK_STATUS_PASSED = 8;
    const ANILINE_DNA_CHECK_STATUS_NG = 9;
    const ANILINE_DNA_CHECK_STATUS_RESENT = 10;
}
