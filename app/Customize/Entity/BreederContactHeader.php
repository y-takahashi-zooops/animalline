...
/**
 * @ORM\Entity(repositoryClass=BreederContactHeaderRepository::class)
 * @ORM\Table(name="ald_breeder_contact_header")
 * @ORM\InheritanceType("SINGLE_TABLE")
 * @ORM\DiscriminatorColumn(name="discriminator_type", type="string", length=255)
 * @ORM\HasLifecycleCallbacks()
 */
class BreederContactHeader
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Customer::class, inversedBy="BreederContactHeader")
     * @ORM\JoinColumns({
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Breeders::class, inversedBy="BreederContactHeader")
     * @ORM\JoinColumn(name="breeder_id", nullable=false)
     */
    private $Breeder;

    /**
     * @ORM\ManyToOne(targetEntity=BreederPets::class, inversedBy="BreederContactHeader")
    ...
    /**
     * @ORM\OneToMany(targetEntity=BreederContacts::class, mappedBy="BreederContactHeader")
     */
    ...
    public function getSendoffReason(): ?string
    {
        return $this->sendoff_reason;
    }

    public function setSendoffReason(string $sendoff_reason): self
    {
    ...
    public function getBreederCheck(): ?int
    {
        return $this->breeder_check;
    }

    public function setBreederCheck(int $breeder_check): self
    {
        $this->breeder_check = $breeder_check;

        return $this;
    }

    public function getBreederNewMsg(): ?int
    {
        return $this->breeder_new_msg;
    }

    public function setBreederNewMsg(int $breeder_new_msg): self
    {
        $this->breeder_new_msg = $breeder_new_msg;
